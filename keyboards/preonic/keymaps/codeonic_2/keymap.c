...
[_SYMBOLS] = LAYOUT_preonic_2x2u( \
  ...
  KC_TILD, KC_AT  , KC_HASH, KC_ASTR, _______, _______, _______, _______, _______, _______, _______, _______, \
  KC_EXLM, _______, KC_MINS, KC_EQL , KC_PLUS, KC_CIRC, KC_DLR , KC_PIPE, KC_AMPR, KC_GRV , KC_QUOT, KC_DQUO, \
  KC_BSLS, _______, _______, KC_UNDS, KC_PERC, _______, _______, _______, _______, _______, _______, _______, \
